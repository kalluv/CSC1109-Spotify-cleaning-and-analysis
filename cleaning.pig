...
-- The dataset has 113900 rows remaining, which means that there was only one tuple containing nulls for these columns.
...
-- After removing duplicates, there dataset has 112613 rows remaining.
